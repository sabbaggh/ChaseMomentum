...
<body style="margin:50px 50px;" >
	<table class="tbl-qa">	
		<thead>
			 <tr>
				<th class="table-header" width="calc(100%/6)">ID </th>
				<th class="table-header" width="calc(100%/6)"> Nombre </th>
				<th class="table-header" width="calc(100%/6)"> Correo </th>
                <th class="table-header" width="calc(100%/6)"> Sitio web </th>
                <th class="table-header" width="calc(100%/6)"> Telefono </th>
                <th class="table-header" width="calc(100%/6)"> Mensaje </th>
			  </tr>
		</thead>
		<tbody>		
			<?php

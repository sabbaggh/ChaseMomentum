        ...
        <div class="registro">
            ...
            if (isset($_POST["submit"])) {
                ...
                if (count($errores) > 0) {
                    ...
                    $sql = "UPDATE forms SET nombre=?, correo=?, sitio=?, telefono=?, mensaje=? WHERE id=?";
                    $stmt = mysqli_stmt_init($conn);
                    $prepareStmt = mysqli_stmt_prepare($stmt,$sql);
                    if ($prepareStmt) {
                        mysqli_stmt_bind_param($stmt,"sssssi", $nombre,$correo,$sitio,$telefono, $mensaje, $_GET["id"]);
            ...
            $sql = $conn->prepare("SELECT * FROM forms WHERE id=?");
            ...
            <form method="post">
                    ...
                    <div class="izq">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-lg" name="nombre"
                                placeholder="Nombre completo" value="<?php echo $row["nombre"] ?>">
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control form-control-lg" name="correo"
                                placeholder="Correo electronico" value="<?php echo $row["correo"] ?>">
                        </div>
                        <div class="form-group">
                            <input type="url" class="form-control form-control-lg" name="sitio"
                                placeholder="Sitio web o red social(opcional)" value="<?php echo $row["sitio"] ?>">
                        </div>
                    </div>
                    <div class="der">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-lg" name="telefono"
                                placeholder="Numero de telefono(opcional)" value="<?php echo $row["telefono"] ?>">
                        </div>
                        <div class="form-group">
                            <textarea name="mensaje" placeholder="Ingresa tu mensaje aqui"
                                style="resize: none;"><?php echo $row["mensaje"] ?></textarea>
                        </div>
                    </div>
                ...
                <div class="botones">
                    <div class="xdd">
                        <a href="formsListMod.php" class="btn btn-secondary btn-lg" role="button">Volver</a>
                    </div>
                    <div class="xdd">
                        <div class="form-btn">
